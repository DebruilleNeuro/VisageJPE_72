...
Screen('DrawText',win1,'the image or the face will then briefly occur.',axis_xg,260,0,255,[],[]);
...
Screen('DrawText',win1,'the image or the face will then briefly occur.',axis_xd,260,0,255,[],[]);
