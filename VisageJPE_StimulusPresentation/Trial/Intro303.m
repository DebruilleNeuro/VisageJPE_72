...
axis_xd = 600;
%pour texte a gauche
Screen('DrawText',win1,'It is very important that you',axis_xg,200,0,255,[],[]);
...
Screen('DrawText',win1,'Do not frown or tighten your jaw. This is really',axis_xg,320,0,255,[],[]);
...
Screen('DrawText',win1,'',axis_xg,380,0,255,[],[]);
Screen('DrawText',win1,'Press the space bar only once to continue.',axis_xg,440,0,255,[],[]);

%pour teste a droiteScreen
Screen('DrawText',win1,'It is very important that you',axis_xd,200,0,255,[],[]);
...
Screen('DrawText',win1,'Do not frown or tighten your jaw. This is really',axis_xd,320,0,255,[],[]);
...
Screen('DrawText',win1,'',axis_xd,380,0,255,[],[]);
